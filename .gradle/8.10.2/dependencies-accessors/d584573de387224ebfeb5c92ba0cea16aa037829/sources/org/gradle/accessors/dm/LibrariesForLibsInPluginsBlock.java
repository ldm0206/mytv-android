...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>androidasync</b> with <b>com.koushikdutta.async:androidasync</b> coordinates and
     * with version reference <b>androidasync</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getAndroidasync() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("androidasync");
    }
    ...
    /**
     * Dependency provider for <b>tinypinyin</b> with <b>io.github.biezhi:TinyPinyin</b> coordinates and
    ...
    public static class AndroidxComposeFoundationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>base</b> with <b>androidx.compose.foundation:foundation</b> coordinates and
         * with version reference <b>compose.foundation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getBase() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.compose.foundation.base");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidasync</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidasync() { return getVersion("androidasync"); }
        ...
        /**
         * Version alias <b>rhino</b> with value <b>1.7.15</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sentry</b> with value <b>4.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tinypinyin</b> with value <b>2.0.3.RELEASE</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tvMaterial</b> with value <b>1.0.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.foundation</b> with value <b>1.7.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final SentryPluginAccessors paccForSentryPluginAccessors = new SentryPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.sentry</b>
         */
        public SentryPluginAccessors getSentry() {
            return paccForSentryPluginAccessors;
        }
    ...
    public static class SentryPluginAccessors extends PluginFactory {
        private final SentryAndroidPluginAccessors paccForSentryAndroidPluginAccessors = new SentryAndroidPluginAccessors(providers, config);

        public SentryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.sentry.android</b>
         */
        public SentryAndroidPluginAccessors getAndroid() {
            return paccForSentryAndroidPluginAccessors;
        }

    }

    public static class SentryAndroidPluginAccessors extends PluginFactory {

        public SentryAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>sentry.android.gradle</b> with plugin id <b>io.sentry.android.gradle</b> and
         * with version reference <b>sentry</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGradle() { return createPlugin("sentry.android.gradle"); }
